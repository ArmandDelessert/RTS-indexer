...
- `--max-pages` (défaut 0, illimité) — plafond exact de pages visitées. `0` = illimité ; le crawl
  s'arrête de lui-même une fois toutes les rubriques connues visitées, la file n'étant pas infinie.
